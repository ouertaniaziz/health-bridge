  ...
  return (
    ...
    >
      <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
        ...
        >
          See why over{' '}
          <chakra.strong color={useColorModeValue('gray.700', 'gray.50')}>15,000+</chakra.strong>{' '}
          Patients use to manage their medication and traitments directly on our website!
        </chakra.h2>
      </Box>
      ...
      <Box>
        <Icon viewBox='0 0 40 35' mt={14} boxSize={10} color={'004AAD'}>
          <path
            fill={'currentColor'}
